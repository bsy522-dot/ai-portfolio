const CACHE='ai-portfolio-v17';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v16_patch.js','./js/v17_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v17_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v17_patch.js"></scr'+'ipt>';
