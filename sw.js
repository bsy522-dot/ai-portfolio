const CACHE='ai-portfolio-v25';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v23_patch.js','./js/v24_patch.js','./js/v25_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v25_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v25_patch.js"></scr'+'ipt>';
