const CACHE='ai-portfolio-v11';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v11_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v11_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v11_patch.js"></scr'+'ipt>';
