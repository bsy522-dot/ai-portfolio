const CACHE='ai-portfolio-v23';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v21_patch.js','./js/v22_patch.js','./js/v23_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v23_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v23_patch.js"></scr'+'ipt>';
