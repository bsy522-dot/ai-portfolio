const CACHE='ai-portfolio-v28';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v26_patch.js','./js/v27_patch.js','./js/v28_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v28_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v28_patch.js"></scr'+'ipt>';
