const CACHE='ai-portfolio-v12';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v12_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v12_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v12_patch.js"></scr'+'ipt>';
