const CACHE='ai-portfolio-v19';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v18_patch.js','./js/v19_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v19_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v19_patch.js"></scr'+'ipt>';
