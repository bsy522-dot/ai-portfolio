const CACHE='ai-portfolio-v18';
const ASSETS=['./index.html','./manifest.json','./og-image.svg','./js/v17_patch.js','./js/v18_patch.js','./games/hatcuping-game.html','./games/hatcuping-rpg.html'];
...
if(html.indexOf('v18_patch')>=0)return new Response(html,{headers:{'Content-Type':'text/html'}});
const tag='<scr'+'ipt src="./js/v18_patch.js"></scr'+'ipt>';
